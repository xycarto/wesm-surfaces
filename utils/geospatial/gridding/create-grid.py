...
# python3 grid/create-grid.py "EPSG:3310"



def main(EPSG, DFBUCKET, GRID_PATH, WIDTH, HEIGHT):
    s3 = get_creds()
    ...
    grid = gp.GeoDataFrame(polygons, crs=EPSG).to_file(f"{GRID_PATH}/grid_index.gpkg", driver="GPKG")

    print(f"Uploading {GRID_PATH}/grid_index.gpkg...")
    s3.upload_file(f"{GRID_PATH}/grid_index.gpkg", DFBUCKET, f"{GRID_PATH}/grid_index.gpkg")
...
if __name__ == "__main__":
    ...
    main(EPSG, DFBUCKET, GRID_PATH, WIDTH, HEIGHT)
