...
def main():
    ...
    print("Creating DEM...")
    dem_file = f"{DEM_DIR}/{os.path.basename(IN_FILE).split('.')[0]}.tif"
    make_surface(PIPELINE_PATH, IN_FILE, metadata.wkt, dem_file, metadata.bounds)    
...
if __name__ == "__main__":
    ...
    DEM_DIR = os.path.join(DATA_DIR, "dem", STATE, WORKUNIT)
